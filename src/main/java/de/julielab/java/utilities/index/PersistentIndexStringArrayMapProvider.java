 ...
 */
abstract public class PersistentIndexStringArrayMapProvider extends StringArrayMapProvider implements Closeable {
    ...
    public PersistentIndexStringArrayMapProvider(Logger log) {
        super(log);
        map = new Map<>() {
            @Override
            public int size() {
